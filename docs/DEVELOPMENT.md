...
- **UI Library :** React 18/19 (avec React Compiler)
...
app/
  ...
  dashboard/           # Page dashboard
    page.tsx
  api/auth/[...all]/   # API routes Better Auth
    route.ts
...
lib/
  ...
  auth/
    client.ts          # Client Better Auth
    index.ts           # Server config Better Auth
...
- ✅ Prisma pour stockage (User, Session, Account) in PostgreSQL
- ✅ Cookies de session gérés par Better Auth via proxy

**Raisons :**

- Contrôle total sur les données
- Pas de dépendance tierce coûteuse (Supabase Auth/Clerk)
- Intégration parfaite avec Next.js et Prisma
- Supporte Email/Password, OAuth, et gestion de session avancée
