...
-- DropForeignKey
ALTER TABLE "study_sessions" DROP CONSTRAINT "study_sessions_createdById_fkey";
...
-- AddForeignKey
ALTER TABLE "study_sessions" ADD CONSTRAINT "study_sessions_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
